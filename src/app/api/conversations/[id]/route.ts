...
import { canRead, conversationById, conversationMessages, markConversationRead, postDirect } from "@/lib/messages";
import { ROLE_LABEL, type Role } from "@/lib/roles";
import { userById } from "@/lib/users";

export const dynamic = "force-dynamic";

/** A private chat's messages. Reading marks them read. */
