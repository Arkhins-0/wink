...
const CLASS = { bold: "font-bold", italic: "italic", underline: "underline", strike: "line-through" } as const;
...
/** A message's words with *bold*, _italic_, __underline__ and ~strikethrough~ shown, markers hidden. */
