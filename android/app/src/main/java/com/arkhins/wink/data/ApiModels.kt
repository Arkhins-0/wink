...
@Serializable
data class Conversation(val id: String, val other: OtherUser, val iOpened: Boolean = false, val lastMessageAt: String? = null, val lastMessage: String? = null, val lastStatus: String? = null, val unread: Int = 0)
